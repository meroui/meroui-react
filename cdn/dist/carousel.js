      ...
      return n(this, void 0, void 0, function () {
        ...
        return t(this, function (t) {
          switch (t.label) {
            ...
            case 3:
              for (n = t.sent(), r = {}, o = 0; o < i.length; ++o)
                r[i[o]] = n[o];
              return [2, r];
          }
        });
...
function _(e) {
  for (
    ...
    var c = a[i],
      u = r[c].join(" ");
    "style" === c ? T(o.style, u) : o.setAttribute(c, u);
  }
  return o;
}
function T(e, n) {
                  ...
                  switch (t.label) {
                    case 0:
                      return (
                        (e = window),
                        (n =
                          e.OfflineAudioContext || e.webkitOfflineAudioContext)
                          ? z()
                            ? [2, -1]
                            : [4, B(n)]
                          : [2, -2]
              ...
              return (
                ...
                (s = function (e) {
                  return U.some(function (n, t) {
                    return (
                      e[t].offsetWidth !== r[n] || e[t].offsetHeight !== o[n]
                    );
                  });
                }),
                (d = (function () {
              ...
              [
                ...
                function () {
                  return (function (e, n) {
                    if (0 === e) return e;
                    var t =
                        Math.floor(Math.log10(Math.abs(e))) - Math.floor(n) + 1,
    ...
    if (t)
      for (var v = 0, h = t; v < h.length; v++) {
        ...
        if (
          ...
          if (b) {
            "WEBGL_polygon_mode" === p && console.log(Se(b));
    ...
    n(this, void 0, void 0, function () {
      ...
      return t(this, function (t) {
        switch (t.label) {
          case 0:
            return (
              e.monitoring, (n = e.delayFallback), (r = e.debug), [4, Ie(n)]
            );
          case 1:
            return (
              t.sent(),
...
var Xe = { load: je, hashComponents: Fe, componentsToDebugString: Re },
  Pe = M;
export {
